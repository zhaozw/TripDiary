...
public class AddPointActivity extends Activity implements Button.OnClickListener {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == R.id.save) {
			if (poi != null && time != null) {
				if (isGpsEnabled) {
					if (POIMarker != null && location != null && POIMarker.getPosition() != null) {
	...
	class RecordAudioTask extends AsyncTask<Integer, Integer, Integer> {
		...
		protected void onPreExecute() {
			...
			try {
				...
				e.printStackTrace();
				Toast.makeText(AddPointActivity.this, getString(R.string.cannot_start_media_recorder_due_to_unknowm_error), Toast.LENGTH_SHORT).show();
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
				Toast.makeText(AddPointActivity.this, getString(R.string.cannot_start_media_recorder_due_to_unknowm_error), Toast.LENGTH_SHORT).show();
