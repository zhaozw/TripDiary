...
public class PaintActivity extends Activity implements OnClickListener{
	...
	public class MyPaintView extends View{
		...
		public boolean onTouchEvent(MotionEvent event){
			...
			case MotionEvent.ACTION_DOWN:onTouchStart(x,y);invalidate();break;
			case MotionEvent.ACTION_MOVE:onTouchMove(x,y);invalidate();break;
			case MotionEvent.ACTION_UP:onTouchUp();invalidate();break;
			}
			return true;
		}
	}
